...
public class SequentialGuid
{
    ...
    /// <summary>
    /// Default .ctor. Initializes <see cref="CurrentGuid"/> with a new value.
    /// </summary>
    ...
    /// <summary>
    /// Constructor that initializes <see cref="CurrentGuid"/> with the provided Guid.
    /// </summary>
    /// <param name="previousGuid">The guid to use to initialize this instance.</param>
